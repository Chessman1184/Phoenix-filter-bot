...
async def set_stream_link(client, message):
    try:
        ...
        if link:
            ...
            await message.reply("Usage: /stream https://t.me/mfilerequest or https://t.me/mfilerequest")
    except IndexError:
        await message.reply("Usage: /stream https://t.me/mfilerequest or https://t.me/mfilerequest")
        return
...
async def m_grp(client, message):
    links = []
    link = await client.ask(message.chat.id ,"send me your pm search grp link or send /skiplink to skip , default is mfilerequest")
    ...
    link1 = await client.ask(message.chat.id ,"send me your movies grp link or send /skiplink to skip . default is mfilerequest")
